...
class TreeManager:
    ...
    def filter_tree_items(self, parent_item, search_text):
        ...
        for i in range(parent_item.childCount()):
            ...
            # Проверяем, соответствует ли текущий элемент поиску
            ...
            # 2. У него есть дочерние элементы, соответствующие поиску
            if matches_search or child_visible_children > 0:
                child.setHidden(False)
                visible_children += 1
                
                # Раскрываем родителей чтобы были видны найденные элементы
